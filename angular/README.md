...
# ProxiedMail Angular Dashboard

ProxiedMail is a private email-forwarding dashboard. It lets users manage proxy addresses, forwarding recipients, account settings, custom domains, and integrations from a focused Angular web application.
